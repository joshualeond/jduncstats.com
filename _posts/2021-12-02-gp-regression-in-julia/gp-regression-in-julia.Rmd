...
author: J. Duncan
date: 2021-12-02
preview: figures/pipeline-example.png
output:
...
![Figure from Probabilistic Machine Learning for Civil Engineers](figures/pipeline-example.png){width=65% .external}   
...
```julia
# Turing is probabilistic programming language similar to Stan
