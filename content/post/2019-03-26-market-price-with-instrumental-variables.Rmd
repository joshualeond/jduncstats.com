...
Bringing this data into R is very easy. This data appears to be the cleand and transformed data used within the paper. Let's read it into our R environment and take a look:
...
The paper informs the reader that transactions recorded are of a particular fish species called Whiting. We can get a feel for the total amount of fish being sold by reproducing Figure `2` from the paper.
...
The naive way in attempting to discover the relationship between price and demand (the demand curve) would be to regress quantity on price:
